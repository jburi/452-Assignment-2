...
public class PlayerWeaponsManager : MonoBehaviour
{
    ...
    private void Update()
    {
		...
		if (isPointingAtEnemy == true)
		{
			...
			WeaponController enemy = hit.collider.GetComponentInParent<WeaponController>();
	...
	//Get element type
	public void getElement(WeaponController active)
	{
		if (active.element is Air)
		{

		}

		if (active.element is Fire)
		{

		}

		if (active.element is Earth)
		{

		}

		if (active.element is Water)
		{
